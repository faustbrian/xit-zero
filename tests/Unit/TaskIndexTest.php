...
describe('TaskIndex::getFiles', function (): void {
    ...
    it('returns all parsed XitFile objects', function (): void {
        ...
        expect($files[0])->toBeInstanceOf(\App\Parser\XitFile::class);
        expect($files[1])->toBeInstanceOf(\App\Parser\XitFile::class);
...
describe('TaskReference', function (): void {
    it('stores file reference correctly', function (): void {
        ...
        // Assert
        expect($reference->file)->toBeInstanceOf(\App\Parser\XitFile::class);
    ...
    it('stores task object correctly', function (): void {
        ...
        // Assert
        expect($reference->task)->toBeInstanceOf(\App\Parser\Task::class);
